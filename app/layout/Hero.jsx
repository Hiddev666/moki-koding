...
const Hero = () => {
    return (
        <div>
            <Navbar />
            <div className="py-5 px-15 h-90 flex justify-center">

                {/* LEFT */}
                <div className="bg-white h-full w-1/5 relative flex justify-center items-center">
                ...
                <div className="bg-white h-full w-3/5 flex flex-col justify-center items-center gap-5">
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="text-8xl font-bold text-moki-blue text-center">Moki Koding</h1>
                        <p className="text-2xl font-medium">Solusi Digital, Eksekusi Total🚀</p>
                    </div>
